                ...
                <div class="col-sm-9  ">
                    <div class="container-fulid">
                        <div class="row bg-dark text-light">
                            <div class="col-sm-10">
                                <h3 class="my-2"><cite>Welcome to Notification</cite></h3>
                            </div>
                        ...
                        <div class="row  text-center mt-5">
                            <h1><cite>ADD Notification</cite></h1>
                        </div>
                        <div class="row">
                            <form action="notification_code.php" method="post">
                                <textarea class="form-control text-center mt-5"placeholder="Add your notification...." name="notification"></textarea>
                                <input class="form-control text-center bg-danger mt-3" type="submit" value="Add">
                            </form>
                        </div>
                        <div class="row text-center mt-5">
                            <h1><cite>See of the Notification List</cite></h1>
                        </div>
                        <div class="row">
